...
<main class="l-concept" id="js-concept-page">
	...
	<section class="l-concept__intro js-scroll-activate" id="js-intro-section">
		<div class="l-concept__intro-text">
			...
			<p class="activate-text">
				昨今のコロナショックによって、<br class="u-show-sp">私たちの生活感は大きく変化しました。​<br>自分らしく生きる。<br class="u-show-sp">そのために好きなところに住む。​<br>これからは、そんな「当たり前の幸せ」を<br class="u-show-sp">叶える時代だと思います。​<br><br>私たちは一つ一つのプロジェクトに<br class="u-show-sp">徹底してこだわります。​<br>立地、デザイン、設計、設備すべてにおいて、​<br>プロフェッショナルチームが「住まう人本位」<br class="u-show-sp">の家づくりを提供します。​
			</p>
		</div>
		...
		<div class="l-concept__thoughts-content activate-box">
			...
			<div class="activate-text">
				<p>
					...
					快適に暮らせる場所、<br class="u-show-sp">趣味を楽しむスペースを確保できる場所。​<br>立地選びが、住んだ後の生活環境を左右します。​<br>だからこそ、候補地の調査や提案にこだわります。
				</p>
				<p>
					<strong>その２.「住まう人本位」の家づくり</strong><br>
					まずは理想の住宅についてお客様と真摯に向き合い、<br>ヒアリングします。​<br>完全オーダーメイドだからこそ、<br>理想を叶える手段が見つかるのです。
				</p>
				<p>
					<strong>その３.「災害に強い」設計と構造</strong><br>
					災害大国の日本でも、<br class="u-show-sp">安心して暮らせる住宅が何よりも大切です。​<br>建築のスペシャリストが技術力を駆使し、<br class="u-show-sp">建築を手掛けます。
				</p>
			</div>
		</div>
	...
	<section class="l-concept__specs js-scroll-activate" id="strength-section">
		<div class="l-container">
			...
			<p class="activate-text">
				...
				建てた後に、嫌な思いはしたくない — <br class="u-show-sp">その気持ちは皆、共通です。<br>
	...
	<section class="l-concept__support js-scroll-activate" id="after-support-section">
		<div class="l-container">
			...
			<p class="activate-text">
				当社アフターサービス基準に則り、最大30年間にわたり住宅品質を保証しています。<br>お客様が保証期間の延長をご希望される場合、<br class="u-show-sp">延長保証点検および、<br>有料メンテナンス工事を実施することで、<br class="u-show-sp">基礎、躯体などの長期保証部位について、<br>さらに10年間延長し、お引き渡しより<br class="u-show-sp">最大30年保証いたします。
			</p>
		</div>
